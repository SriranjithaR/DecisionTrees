...
plt.errorbar(x = x, y = avgzolbag, yerr = avgstderrbag, ecolor='c', capthick=2)
plt.errorbar(x = x, y = avgzolrf, yerr = avgstderrrf, ecolor='k', capthick=2)
plt.errorbar(x = x, y = avgzolsvm, yerr = avgstderrsvm, ecolor='r', capthick=2)
